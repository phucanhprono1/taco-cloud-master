...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, Spring HATEOAS,
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/docs/2.7.0/reference/htmlsingle/#boot-features-spring-hateoas)
...
```
$ docker run --rm -p 8080:8080 taco-cloud-client:0.0.1-SNAPSHOT
```
